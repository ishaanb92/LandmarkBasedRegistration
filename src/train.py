...
def train(args):
    ...
    for epoch in range(10000):
        ...
        for batch_idx, batch_data in pbar:
            ...
            writer.add_scalar('train/landmark_1_pos_weight', loss_dict['landmark_1_pos_weight'].item(), n_iter)
            writer.add_scalar('train/landmark_2_pos_weight', loss_dict['landmark_2_pos_weight'].item(), n_iter)
        ...
        with torch.no_grad():
            ...
            for batch_val_idx, val_data in pbar_val:
                ...
                writer.add_scalar('val/landmark_1_pos_weight', loss_dict['landmark_1_pos_weight'].item(), n_iter_val)
                writer.add_scalar('val/landmark_2_pos_weight', loss_dict['landmark_2_pos_weight'].item(), n_iter_val)
